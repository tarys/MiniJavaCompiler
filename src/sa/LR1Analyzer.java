...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Apr 02 04:37:09 EEST 2012
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$LR1Analyzer$act_num)
		...
		Integer value = (Integer)((java_cup.runtime.Symbol) CUP$LR1Analyzer$stack.peek()).value;
		 ...
		 RESULT = SymbolsInfo.BOOLEAN_TYPE; 
          ...
          case 40: // variable_declaration ::= type IDENTIFIER ASSIGN expression SEMICOLON 
            {
              Entry RESULT =null;
		int typeIdleft = ((java_cup.runtime.Symbol)CUP$LR1Analyzer$stack.elementAt(CUP$LR1Analyzer$top-4)).left;
		int typeIdright = ((java_cup.runtime.Symbol)CUP$LR1Analyzer$stack.elementAt(CUP$LR1Analyzer$top-4)).right;
		Integer typeId = (Integer)((java_cup.runtime.Symbol) CUP$LR1Analyzer$stack.elementAt(CUP$LR1Analyzer$top-4)).value;
		...
		Object value = (Object)((java_cup.runtime.Symbol) CUP$LR1Analyzer$stack.elementAt(CUP$LR1Analyzer$top-1)).value;
                                        ...
                                        RESULT = parser.getNameTableBuilder().declareEntity(typeId, name, value);
		...
		String name = (String)((java_cup.runtime.Symbol) CUP$LR1Analyzer$stack.elementAt(CUP$LR1Analyzer$top-1)).value;
                                        ...
                                        RESULT = parser.getNameTableBuilder().declareEntity(typeId, name);
		...
		List<Entry> variablesEntriesList = (List<Entry>)((java_cup.runtime.Symbol) CUP$LR1Analyzer$stack.peek()).value;
          ...
          case 33: // param_declaration ::= type IDENTIFIER 
            {
              Entry RESULT =null;
		int typeIdleft = ((java_cup.runtime.Symbol)CUP$LR1Analyzer$stack.elementAt(CUP$LR1Analyzer$top-1)).left;
		int typeIdright = ((java_cup.runtime.Symbol)CUP$LR1Analyzer$stack.elementAt(CUP$LR1Analyzer$top-1)).right;
		Integer typeId = (Integer)((java_cup.runtime.Symbol) CUP$LR1Analyzer$stack.elementAt(CUP$LR1Analyzer$top-1)).value;
		int nameleft = ((java_cup.runtime.Symbol)CUP$LR1Analyzer$stack.peek()).left;
		int nameright = ((java_cup.runtime.Symbol)CUP$LR1Analyzer$stack.peek()).right;
		String name = (String)((java_cup.runtime.Symbol) CUP$LR1Analyzer$stack.peek()).value;
		
                                           RESULT = parser.getNameTableBuilder().declareEntity(SymbolsInfo.param_declaration, name, typeId);
